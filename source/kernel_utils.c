...
int kpayload_jailbreak(struct thread *td, struct kpayload_jailbreak_args *args) {
  ...
  *sceProcCap = 0xffffffffffffffff;
  ...
  void (*sceSblSrtcClearTimeDifferenceMode1)(void) = 0;
  void (*sceSblSrtcClearTimeDifferenceMode2)(void) = 0;
  void (*sceSblSrtcSetTimeMode1)(uint64_t tm) = 0;
  void (*sceSblSrtcSetTimeMode2)(uint64_t tm) = 0;
  ...
  if (fw_version == 0x350) {
    ...
    *(void **)(&sceSblSrtcClearTimeDifferenceMode1) = &kernel_ptr[K700_CLEAR_TIME_DIFF_MODE_1];
    *(void **)(&sceSblSrtcClearTimeDifferenceMode2) = &kernel_ptr[K700_CLEAR_TIME_DIFF_MODE_2];
    *(void **)(&sceSblSrtcSetTimeMode1) = &kernel_ptr[K700_SET_TIME_MODE_1];
    *(void **)(&sceSblSrtcSetTimeMode2) = &kernel_ptr[K700_SET_TIME_MODE_2];
    sceSblSrtcClearTimeDifference(15);
    sceSblSrtcClearTimeDifferenceMode1();
    sceSblSrtcClearTimeDifferenceMode2();
  } else {
    return -1;
  }

  if (sceSblSrtcSetTimeMode1) {
    sceSblSrtcSetTimeMode1(14861963);
  }

  if (sceSblSrtcSetTimeMode2) {
    sceSblSrtcSetTimeMode2(14861963);
  }
